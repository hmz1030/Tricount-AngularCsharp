...
public class UserConfigurations : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> e) 
    {
        ...
        e.HasData(
            ...
            new User { Id = 4, Name = "Marc", Email = "boverhaegen@epfc.eu", Iban = "BE12 1234 1234 1234", Password = "Password1" },
            new User { Id = 5, Name = "Geoffrey", Email = "boverhaegen@epfc.eu", Iban = "BE45 4567 4567 4567",  Password = "Password1" }
        );
